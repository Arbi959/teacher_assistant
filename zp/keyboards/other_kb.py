...
kb_stats = [InlineKeyboardButton(text="Общая статистика 📈", web_app=WebAppInfo(url=f"https://1214-2a03-d000-1405-f5c5-261c-395b-909d-5782.ngrok-free.app/reg/other_groups")), InlineKeyboardButton(text="Статистика группы 📉", callback_data="stat_group")]
...
def mk_group_stat(name_group):
    ...
    kb_group_one = KeyboardButton("Открыть статистику", web_app=WebAppInfo(url=f"https://1214-2a03-d000-1405-f5c5-261c-395b-909d-5782.ngrok-free.app/reg/{name_group}"))
